...
const renderComponent = (id: string, container: HTMLDivElement, event: React.DragEvent<HTMLDivElement>) => {
...
export const handleDrop: DragEventHandler<HTMLDivElement> = (event) => {
    ...
    if (event.currentTarget) {
      renderComponent(id, event.currentTarget as HTMLDivElement, event);
